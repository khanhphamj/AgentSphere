const PROFILES = {
  ...
  "gemini/gemini-2.5-flash": { tier: "mid", reasoning: 3, quantitative: 3, web: 4, coding: 3, synthesis: 3, vi: 4, speed: 4, cost: 2, rateLimitRisk: 3, jsonNative: true },
  "gemini/gemini-2.5-flash-lite": { tier: "small", reasoning: 2, quantitative: 2, web: 3, coding: 2, synthesis: 2, vi: 3, speed: 5, cost: 1, rateLimitRisk: 2, jsonNative: true },
  "deepseek/deepseek-v4-flash": { tier: "mid", reasoning: 3, quantitative: 3, web: 3, coding: 4, synthesis: 3, vi: 4, speed: 4, cost: 1, rateLimitRisk: 3, jsonNative: false },
  "deepseek/deepseek-chat": { tier: "mid", reasoning: 3, quantitative: 3, web: 3, coding: 3, synthesis: 3, vi: 4, speed: 4, cost: 1, rateLimitRisk: 3, jsonNative: false },
  "kimi/kimi-k2.6": { tier: "strong", reasoning: 4, quantitative: 4, web: 4, coding: 4, synthesis: 4, vi: 3, speed: 3, cost: 2, rateLimitRisk: 3, jsonNative: false },
  "kimi/kimi-k2.7-code": { tier: "coder", reasoning: 4, quantitative: 3, web: 3, coding: 5, synthesis: 3, vi: 3, speed: 3, cost: 2, rateLimitRisk: 3, jsonNative: false },
  "z-ai/glm-5.2": { tier: "strong", reasoning: 4, quantitative: 4, web: 4, coding: 4, synthesis: 4, vi: 4, speed: 3, cost: 2, rateLimitRisk: 3, jsonNative: false },
  "z-ai/glm-5.2-thirdparty": { tier: "strong", reasoning: 4, quantitative: 4, web: 4, coding: 4, synthesis: 4, vi: 4, speed: 3, cost: 2, rateLimitRisk: 3, jsonNative: false },
  "minimax/minimax-m3": { tier: "strong", reasoning: 4, quantitative: 4, web: 4, coding: 4, synthesis: 4, vi: 3, speed: 3, cost: 2, rateLimitRisk: 3, jsonNative: false },
